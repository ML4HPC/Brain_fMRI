...
np.save(base_path + 'train_siemens_t1.npy', train_siemens_t1)
np.save(base_path + 'train_siemens_t2.npy', train_siemens_t2)
np.save(base_path + 'train_siemens_fa.npy', train_siemens_fa)
np.save(base_path + 'train_siemens_md.npy', train_siemens_md)
np.save(base_path + 'train_siemens_rd.npy', train_siemens_rd)
np.save(base_path + 'train_siemens_ad.npy', train_siemens_ad)

np.save(base_path + 'valid_siemens_t1.npy', valid_siemens_t1)
np.save(base_path + 'valid_siemens_t2.npy', valid_siemens_t2)
np.save(base_path + 'valid_siemens_fa.npy', valid_siemens_fa)
np.save(base_path + 'valid_siemens_md.npy', valid_siemens_md)
np.save(base_path + 'valid_siemens_rd.npy', valid_siemens_rd)
np.save(base_path + 'valid_siemens_ad.npy', valid_siemens_ad)

np.save(base_path + 'test_siemens_t1.npy', test_siemens_t1)
np.save(base_path + 'test_siemens_t2.npy', test_siemens_t2)
np.save(base_path + 'test_siemens_fa.npy', test_siemens_fa)
np.save(base_path + 'test_siemens_md.npy', test_siemens_md)
np.save(base_path + 'test_siemens_rd.npy', test_siemens_rd)
np.save(base_path + 'test_siemens_ad.npy', test_siemens_ad)

np.save(base_path + 'train_target_siemens.npy', train_target_siemens)
np.save(base_path + 'valid_target_siemens.npy', valid_target_siemens)
np.save(base_path + 'test_target_siemens.npy', test_target_siemens)
