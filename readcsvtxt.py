...
def get_covariates(key, acspsw_data, abcd_data, pdemo_data):
    ...
    high_edu = max(pdemo_row['demo_prnt_ed_v2'].astype(int) if not pdemo_row['demo_prnt_ed_v2'].isnull() else 0, pdemo_row['demo_prtnr_ed_v2'].astype(int) if not pdemo_row['demo_prtnr_ed_v2'].isnull() else 0)
