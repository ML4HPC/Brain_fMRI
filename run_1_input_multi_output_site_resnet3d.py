...
if __name__ == "__main__":
    ...
    train_dataset   =   MultiMRIDatasetBySite(train_img, train_target, args.resize, norms, args.log, args.nan, parsed_site)
    train_loader    =   torch.utils.data.DataLoader(train_dataset, batch_size=args.train_batch_size, shuffle=True)
    valid_dataset   =   MultiMRIDatasetBySite(valid_img, valid_target, args.resize, norms, args.log, args.nan, parsed_site)
    valid_loader    =   torch.utils.data.DataLoader(valid_dataset, batch_size=args.valid_batch_size)
    test_dataset    =   MultiMRIDatasetBySite(test_img,test_target, args.resize, norms, args.log, args.nan, parsed_site)
